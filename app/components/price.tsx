...
export default function PriceView({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-[500px] bg-[#0d0d0d] text-white">
    ...
    <div>
      ...
      <div className="container mx-auto p-10">
        {/* <header className="text-center py-4">
          <h1 className="text-3xl font-bold">Uruloki Swap</h1>
        </header> */}
            ...
            {({
              ...
              return (
                <button
                  ...
                  type="button"
                >
                  {isConnected ? ensName ?? truncatedAddress : "Select Wallet"}
                </button>
              );
            }}
          </ConnectKitButton.Custom>
